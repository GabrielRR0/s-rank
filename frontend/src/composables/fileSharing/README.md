...
`useTurnstile.ts` se mudó a `composables/useTurnstile.ts` (sin carpeta de dominio) en cuanto `secretChat` necesitó lo mismo - ver ese archivo y `components/ui/TurnstileWidget.vue`.
