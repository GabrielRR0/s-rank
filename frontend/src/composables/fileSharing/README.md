...
- **`useUpload.ts`**: estado del flujo de creación (modo texto/archivo, contraseña opcional, expiración elegida, validación, llamada al servicio, manejo de error). Usado por `FileSharingMain.vue`.
